...
-- CreateEnum
CREATE TYPE "TransactionCategory" AS ENUM ('CREDIT_CARD', 'INTERNET', 'ENTERTAINMENT', 'FOOD_CARD', 'HEALTH', 'PHONE_BILL', 'HOUSING', 'OTHER', 'SALARY', 'STORE_CARDS', 'TRANSPORTATION', 'UTILITY');
